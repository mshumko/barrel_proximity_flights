...
ephem_save_name = 'barrel_4g_4f_merged_ephemeris.csv'

fs_save_name = 'barrel_4g_4f_merged_fast_spectra.csv'
...
ephem_merged['dist_km'] = data_preprocessing.haversine(
                    ...
                    ephem_merged[['4F_GPS_Lat', '4F_GPS_Lon', '4F_GPS_Alt']]
                                                        )
